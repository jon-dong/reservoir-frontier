...
resolution = [100, 100]  # number of weight and bias scales
chunks = [1, 1]
n_save_last = 100
...
if save:
    ...
    np.save(data_folder + save_folder + "errs.npy", errs.cpu().numpy())
    print(f"Saved errs to {data_folder + save_folder}errs.npy")
